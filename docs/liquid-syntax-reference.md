...
Generic Shopify Liquid language reference (delimiters, operators, filters, objects, tags).
Not project-specific — extracted from AGENTS.md to keep that file short. Read this when
unsure about exact Liquid syntax, filter signatures, or object availability per page type.
