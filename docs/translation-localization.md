...
Full detail behind the condensed translation rules in AGENTS.md — file structure,
key-organization examples, schema-locale conventions. Read when adding or restructuring
locale keys, not for a single `| t` call.
